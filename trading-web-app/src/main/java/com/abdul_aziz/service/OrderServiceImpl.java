...
import com.abdul_aziz.entity.*;
import com.abdul_aziz.repository.OrderItemRepository;
import com.abdul_aziz.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    private OrderItem createOrder(Coin coin, double quantity,
    ...
    public Order buyAsset(Coin coin, double quantity, User user) throws Exception {
        ...
        OrderItem orderItem = createOrder(coin, quantity, buyPrice, 0);
    ...
    public Order sellAsset(Coin coin, double quantity, User user) throws Exception {
        ...
        if (assetToSell != null) {
            OrderItem orderItem = createOrder(coin, quantity, 0, sellPrice);
